var krell_Module = (() => {
  ...
  return (
      function(krell_Module) {
          krell_Module = krell_Module || {};

          var Module = typeof krell_Module != "undefined" ? krell_Module : {};
          var readyPromiseResolve, readyPromiseReject;
          Module["ready"] = new Promise(function(resolve, reject) {
              readyPromiseResolve = resolve;
              readyPromiseReject = reject
          });
          ["_hv_krell_new", "_hv_krell_new_with_options", "_hv_delete", "_hv_processInline", "_hv_getNumInputChannels", "_hv_getNumOutputChannels", "_hv_samplesToMilliseconds", "_hv_setPrintHook", "_hv_setSendHook", "_hv_sendFloatToReceiver", "_hv_sendBangToReceiver", "_hv_sendSymbolToReceiver", "_hv_stringToHash", "_hv_msg_getByteSize", "_hv_msg_init", "_hv_msg_hasFormat", "_hv_msg_setFloat", "_hv_msg_getFloat", "_hv_msg_getTimestamp", "_hv_table_getLength", "_hv_table_setLength", "_hv_table_getBuffer", "_hv_sendMessageToReceiverV", "_malloc", "_fflush", "onRuntimeInitialized"].forEach(prop => {
          ...
          var _hv_getNumInputChannels = Module["_hv_getNumInputChannels"] = createExportWrapper("hv_getNumInputChannels");
          var _hv_getNumOutputChannels = Module["_hv_getNumOutputChannels"] = createExportWrapper("hv_getNumOutputChannels");
          var _malloc = Module["_malloc"] = createExportWrapper("malloc");
          var _hv_krell_new = Module["_hv_krell_new"] = createExportWrapper("hv_krell_new");
          var _hv_krell_new_with_options = Module["_hv_krell_new_with_options"] = createExportWrapper("hv_krell_new_with_options");
          var _hv_table_setLength = Module["_hv_table_setLength"] = createExportWrapper("hv_table_setLength");
          var _hv_table_getBuffer = Module["_hv_table_getBuffer"] = createExportWrapper("hv_table_getBuffer");
          var _hv_table_getLength = Module["_hv_table_getLength"] = createExportWrapper("hv_table_getLength");
          var _hv_msg_getByteSize = Module["_hv_msg_getByteSize"] = createExportWrapper("hv_msg_getByteSize");
          var _hv_msg_init = Module["_hv_msg_init"] = createExportWrapper("hv_msg_init");
          var _hv_msg_getTimestamp = Module["_hv_msg_getTimestamp"] = createExportWrapper("hv_msg_getTimestamp");
          var _hv_msg_getFloat = Module["_hv_msg_getFloat"] = createExportWrapper("hv_msg_getFloat");
          var _hv_msg_setFloat = Module["_hv_msg_setFloat"] = createExportWrapper("hv_msg_setFloat");
          var _hv_msg_hasFormat = Module["_hv_msg_hasFormat"] = createExportWrapper("hv_msg_hasFormat");
          var _hv_setPrintHook = Module["_hv_setPrintHook"] = createExportWrapper("hv_setPrintHook");
          var _hv_setSendHook = Module["_hv_setSendHook"] = createExportWrapper("hv_setSendHook");
          var _hv_stringToHash = Module["_hv_stringToHash"] = createExportWrapper("hv_stringToHash");
          var _hv_sendBangToReceiver = Module["_hv_sendBangToReceiver"] = createExportWrapper("hv_sendBangToReceiver");
          var _hv_sendFloatToReceiver = Module["_hv_sendFloatToReceiver"] = createExportWrapper("hv_sendFloatToReceiver");
          var _hv_sendSymbolToReceiver = Module["_hv_sendSymbolToReceiver"] = createExportWrapper("hv_sendSymbolToReceiver");
          var _hv_sendMessageToReceiverV = Module["_hv_sendMessageToReceiverV"] = createExportWrapper("hv_sendMessageToReceiverV");
          var _hv_samplesToMilliseconds = Module["_hv_samplesToMilliseconds"] = createExportWrapper("hv_samplesToMilliseconds");
          ...
          AudioLibLoader.prototype.init = function(options) {
              this.webAudioContext = options.webAudioContext || new(window.AudioContext || window.webkitAudioContext || null);
              if (this.webAudioContext) {
                  return (async () => {
                      var blockSize = options.blockSize || 2048;
                      if (audioWorkletSupported) {
                          await this.webAudioContext.audioWorklet.addModule("krell_AudioLibWorklet.js");
                          this.webAudioWorklet = new AudioWorkletNode(this.webAudioContext, "krell_AudioLibWorklet", {
                          ...
                          this.webAudioWorklet.port.onmessage = event => {
                              console.log("Message from krell_AudioLibWorklet:", event.data)
                          };
                          ...
                          var instance = new krell_AudioLib({
                              sampleRate: this.webAudioContext.sampleRate,
                              blockSize: blockSize,
          ...
          var krell_AudioLib = function(options) {
          ...
          var tableHashes = {};
          krell_AudioLib.prototype.process = function(event) {
          ...
          krell_AudioLib.prototype.getNumInputChannels = function() {
              return this.heavyContext ? _hv_getNumInputChannels(this.heavyContext) : -1
          };
          krell_AudioLib.prototype.getNumOutputChannels = function() {
              return this.heavyContext ? _hv_getNumOutputChannels(this.heavyContext) : -1
          };
          krell_AudioLib.prototype.setPrintHook = function(hook) {
          ...
          krell_AudioLib.prototype.setSendHook = function(hook) {
              if (!this.heavyContext) {
          ...
          krell_AudioLib.prototype.sendEvent = function(name) {
              if (this.heavyContext) {
                  _hv_sendBangToReceiver(this.heavyContext, eventInHashes[name])
              }
          };
          krell_AudioLib.prototype.setFloatParameter = function(name, floatValue) {
              if (this.heavyContext) {
                  _hv_sendFloatToReceiver(this.heavyContext, parameterInHashes[name], parseFloat(floatValue))
              }
          };
          krell_AudioLib.prototype.sendStringToReceiver = function(name, message) {
              if (this.heavyContext) {
          ...
          krell_AudioLib.prototype.fillTableWithFloatBuffer = function(name, buffer) {
          ...
          Module.krell_AudioLib = krell_AudioLib;


          return krell_Module.ready
      }
  );
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = krell_Module;
else if (typeof define === 'function' && define['amd'])
  define([], function() {
      return krell_Module;
  });
else if (typeof exports === 'object')
  exports["krell_Module"] = krell_Module;